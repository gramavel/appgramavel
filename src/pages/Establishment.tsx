        ...
        <SheetContent side="bottom" className="rounded-t-2xl max-h-[85vh] overflow-y-auto">
          ...
          <div className="space-y-4 pt-4">
            ...
            <div className="flex items-center justify-evenly pt-2">
              ...
              {est.youtube && (
                <a href={est.youtube} target="_blank" rel="noopener" className="h-10 w-10 rounded-full bg-secondary flex items-center justify-center hover:bg-secondary/80 transition-colors">
              ...
              {est.twitter && (
                <a href={`https://x.com/${est.twitter}`} target="_blank" rel="noopener" className="h-10 w-10 rounded-full bg-secondary flex items-center justify-center hover:bg-secondary/80 transition-colors">
