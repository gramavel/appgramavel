...
export default function Profile() {
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <main className="max-w-2xl mx-auto pb-20 space-y-0">
        ...
        <div className="relative">
          ...
          <div className="flex flex-col items-center -mt-14 relative z-10 px-4">
            ...
            <h2 className="text-lg font-bold text-foreground mt-2">João da Silva</h2>
        ...
        {/* Stats Row */}
        <div className="flex justify-around py-3 mx-4 mt-3 bg-card rounded-xl border border-border/50">
        ...
        {earnedBadges.length > 0 && (
          <div className="px-4 mt-4">
            <div className="flex items-center justify-between mb-2">
              <span className="text-[11px] font-bold tracking-widest text-muted-foreground uppercase">Conquistas recentes</span>
        ...
        <div className="px-4 mt-5">
          <div className="flex items-center justify-between mb-3">
            <span className="text-[11px] font-bold tracking-widest text-muted-foreground uppercase">Minha viagem</span>
            ...
            <div className="space-y-2">
              {MOCK_TIMELINE.map((item, idx) => {
                ...
                return (
                  <div
                    key={item.id}
                    className="relative flex items-center gap-3 p-2.5 bg-card/60 rounded-xl border border-border/30 hover:bg-card transition-colors"
                  ...
                  >
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <p className="text-[11px] text-muted-foreground mt-0.5">{new Date(item.date).toLocaleDateString("pt-BR")}</p>
                    </div>
                  </div>
                );
              })}
        ...
        <div className="px-4 mt-5">
          <div className="flex justify-between items-center mb-2">
            <div className="flex items-center gap-1.5">
              ...
              <span className="text-[11px] font-bold tracking-widest text-muted-foreground uppercase">Memórias ({MEMORIES.length})</span>
            </div>
          ...
          <div className="grid grid-cols-3 gap-1.5">
            {MEMORIES.map((mem, i) => {
              // Create visual variety: every 4th and 7th item spans taller
              const isTall = i % 5 === 0;
              return (
                <div
                  key={i}
